...
#
# Generated Tue Sep 19 18:31:15 2023 by generateDS.py version 2.43.2.
# Python 3.10.12 (main, Jun 11 2023, 05:26:28) [GCC 11.4.0]
#
# Command line options:
#   ('-o', 'mdfelib/v3_00/retConsSitMDFe.py')
#
# Command line arguments:
#   schemas/v3_00/retConsSitMDFe_v3.00.xsd
#
# Command line:
#   /usr/local/bin/generateDS -o "mdfelib/v3_00/retConsSitMDFe.py" schemas/v3_00/retConsSitMDFe_v3.00.xsd
#
...
class versaoType1(str, Enum):
    _1_00='1.00'
    _3_00='3.00'


class versaoType2(str, Enum):
    _1_00='1.00'
    _3_00='3.00'
...
class TConsSitMDFe(GeneratedsSuper):
    """TConsSitMDFe -- Tipo Pedido de Consulta da Situa
    ç
    ã
    o Atual do MDF-e
    tpAmb -- Identifica
    ...
    ã
    o do MDF-e, CNPJ do emitente, modelo, s
    é
    rie, tipo de emiss
    ã
    o e n
    ...
    subclass = None
    superclass = None
    def __init__(self, versao=None, tpAmb=None, xServ=None, chMDFe=None, gds_collector_=None, **kwargs_):
    ...
    def validate_TServ(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            ...
            if not self.gds_validate_simple_patterns(
                ...
                self.gds_collector_.add_message('Value "%s" does not match xsd pattern restrictions: %s' % (encode_str_2_3(value), self.validate_TServ_patterns_, ))
                result = False
        return result
    ...
    def validate_versaoType(self, value):
        # Validate type versaoType, a restriction on TVerConsSitMDFe.
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, str):
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s"%(lineno)s is not of the correct base simple type (str)' % {"value": value, "lineno": lineno, })
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.w3.org/2001/XMLSchema" ', name_='TConsSitMDFe', pretty_print=True):
        ...
        if pretty_print:
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'TConsSitMDFe':
        ...
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='TConsSitMDFe')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='TConsSitMDFe', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='TConsSitMDFe'):
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.w3.org/2001/XMLSchema" ', name_='TConsSitMDFe', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class TRetConsSitMDFe(GeneratedsSuper):
    """TRetConsSitMDFe -- Tipo Retorno de Pedido de Consulta da Situa
    ç
    ã
    o Atual do MDF-e
    tpAmb -- Identifica
    ...
    cUF -- c
    ó
    digo da UF de atendimento
    
    """
    __hash__ = GeneratedsSuper.__hash__
    subclass = None
    superclass = None
    def __init__(self, versao=None, tpAmb=None, verAplic=None, cStat=None, xMotivo=None, cUF=None, protMDFe=None, procEventoMDFe=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
        ...
        self.procEventoMDFe_nsprefix_ = None
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
    ...
    def set_protMDFe(self, protMDFe):
        self.protMDFe = protMDFe
    def get_procEventoMDFe(self):
        return self.procEventoMDFe
    def set_procEventoMDFe(self, procEventoMDFe):
        self.procEventoMDFe = procEventoMDFe
    def add_procEventoMDFe(self, value):
        self.procEventoMDFe.append(value)
    def insert_procEventoMDFe_at(self, index, value):
        self.procEventoMDFe.insert(index, value)
    def replace_procEventoMDFe_at(self, index, value):
        self.procEventoMDFe[index] = value
    def get_versao(self):
        return self.versao
    def set_versao(self, versao):
        self.versao = versao
    ...
    def validate_TVerConsSitMDFe(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            ...
            if not self.gds_validate_simple_patterns(
                ...
                self.gds_collector_.add_message('Value "%s" does not match xsd pattern restrictions: %s' % (encode_str_2_3(value), self.validate_TVerConsSitMDFe_patterns_, ))
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.w3.org/2001/XMLSchema" ', name_='TRetConsSitMDFe', pretty_print=True):
        ...
        if pretty_print:
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'TRetConsSitMDFe':
            name_ = self.original_tagname_
        if UseCapturedNS_ and self.ns_prefix_:
            namespaceprefix_ = self.ns_prefix_ + ':'
        showIndent(outfile, level, pretty_print)
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='TRetConsSitMDFe')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='TRetConsSitMDFe', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='TRetConsSitMDFe'):
        if self.versao is not None and 'versao' not in already_processed:
            already_processed.add('versao')
            outfile.write(' versao=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.versao), input_name='versao')), ))
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.w3.org/2001/XMLSchema" ', name_='TRetConsSitMDFe', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        for procEventoMDFe_ in self.procEventoMDFe:
            namespaceprefix_ = self.procEventoMDFe_nsprefix_ + ':' if (UseCapturedNS_ and self.procEventoMDFe_nsprefix_) else ''
            procEventoMDFe_.export(outfile, level, namespaceprefix_, namespacedef_='', name_='procEventoMDFe', pretty_print=pretty_print)
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
            self.gds_elementtree_node_ = node
    ...
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'tpAmb':
            ...
            obj_ = protMDFeType.factory(parent_object_=self)
            obj_.build(child_, gds_collector_=gds_collector_)
            self.protMDFe = obj_
            obj_.original_tagname_ = 'protMDFe'
        elif nodeName_ == 'procEventoMDFe':
            obj_ = procEventoMDFeType.factory(parent_object_=self)
            obj_.build(child_, gds_collector_=gds_collector_)
...
class protMDFeType(GeneratedsSuper):
    """ -- Retornar protMDFe da vers
    ã
    o correspondente do MDF-e autorizado
    
    """
    __hash__ = GeneratedsSuper.__hash__
    subclass = None
    superclass = None
    def __init__(self, versao=None, anytypeobjs_=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
    ...
    def set_versao(self, versao):
        self.versao = versao
    def validate_versaoType1(self, value):
        # Validate type versaoType1, a restriction on xs:string.
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, str):
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s"%(lineno)s is not of the correct base simple type (str)' % {"value": value, "lineno": lineno, })
                return False
            value = value
            enumerations = ['1.00', '3.00']
            if value not in enumerations:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s"%(lineno)s does not match xsd enumeration restriction on versaoType1' % {"value" : encode_str_2_3(value), "lineno": lineno} )
                result = False
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.w3.org/2001/XMLSchema" ', name_='protMDFeType', pretty_print=True):
        ...
        if pretty_print:
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'protMDFeType':
            name_ = self.original_tagname_
        if UseCapturedNS_ and self.ns_prefix_:
            namespaceprefix_ = self.ns_prefix_ + ':'
        showIndent(outfile, level, pretty_print)
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='protMDFeType')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='protMDFeType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='protMDFeType'):
        if self.versao is not None and 'versao' not in already_processed:
            already_processed.add('versao')
            outfile.write(' versao=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.versao), input_name='versao')), ))
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.w3.org/2001/XMLSchema" ', name_='protMDFeType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def _buildAttributes(self, node, attrs, already_processed):
        ...
        if value is not None and 'versao' not in already_processed:
            already_processed.add('versao')
            self.versao = value
            self.validate_versaoType1(self.versao)    # validate type versaoType1
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        content_ = self.gds_build_any(child_, 'protMDFeType')
        self.set_anytypeobjs_(content_)
# end class protMDFeType


class procEventoMDFeType(GeneratedsSuper):
    """ -- Retornar procEventoMDFe da vers
    ã
    o correspondente do evento MDF-e autorizado
    ...
    def set_versao(self, versao):
        self.versao = versao
    def validate_versaoType2(self, value):
        # Validate type versaoType2, a restriction on xs:string.
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, str):
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s"%(lineno)s is not of the correct base simple type (str)' % {"value": value, "lineno": lineno, })
            ...
            if value not in enumerations:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s"%(lineno)s does not match xsd enumeration restriction on versaoType2' % {"value" : encode_str_2_3(value), "lineno": lineno} )
                result = False
    def has__content(self):
        if (
            self.anytypeobjs_ is not None
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.w3.org/2001/XMLSchema" ', name_='procEventoMDFeType', pretty_print=True):
        ...
        if pretty_print:
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'procEventoMDFeType':
            name_ = self.original_tagname_
        if UseCapturedNS_ and self.ns_prefix_:
            namespaceprefix_ = self.ns_prefix_ + ':'
        showIndent(outfile, level, pretty_print)
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='procEventoMDFeType')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='procEventoMDFeType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='procEventoMDFeType'):
        if self.versao is not None and 'versao' not in already_processed:
            already_processed.add('versao')
            outfile.write(' versao=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.versao), input_name='versao')), ))
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.w3.org/2001/XMLSchema" ', name_='procEventoMDFeType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def _buildAttributes(self, node, attrs, already_processed):
        ...
        if value is not None and 'versao' not in already_processed:
            already_processed.add('versao')
            self.versao = value
            self.validate_versaoType2(self.versao)    # validate type versaoType2
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        content_ = self.gds_build_any(child_, 'procEventoMDFeType')
        self.set_anytypeobjs_(content_)
...
def parse(inFileName, silence=False, print_warnings=True):
    ...
    if rootClass is None:
        rootTag = 'TRetConsSitMDFe'
        rootClass = TRetConsSitMDFe
...
def parseLiteral(inFileName, silence=False, print_warnings=True):
    ...
    if not SaveElementTreeNode:
        ...
        rootNode = None
    if not silence:
        sys.stdout.write('#from retConsSitMDFe import *\n\n')
        sys.stdout.write('import retConsSitMDFe as model_\n\n')
...
NamespaceToDefMappings_ = {'http://www.portalfiscal.inf.br/mdfe': [('TDateTimeUTC',
                                         ...
                                         ('TPlaca',
                                          ...
                                          'ST'),
                                         ('TVerConsSitMDFe',
                                          'schemas/v3_00/consSitMDFeTiposBasico_v3.00.xsd',
                                          'ST'),
                                         ('TConsSitMDFe',
                                          'schemas/v3_00/consSitMDFeTiposBasico_v3.00.xsd',
                                          'CT'),
