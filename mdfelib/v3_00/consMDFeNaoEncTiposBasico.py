...
#   ('--no-process-includes', '')
#   ('-o', 'mdfelib/v3_00/consMDFeNaoEncTiposBasico.py')
#
# Command line arguments:
#   schemas/v3_00/consMDFeNaoEncTiposBasico_v3.00.xsd
#
# Command line:
#   /usr/local/bin/generateDS --no-process-includes -o "mdfelib/v3_00/consMDFeNaoEncTiposBasico.py" schemas/v3_00/consMDFeNaoEncTiposBasico_v3.00.xsd
#
...
def parseLiteral(inFileName, silence=False):
    ...
    doc = None
    if not silence:
        sys.stdout.write('#from consMDFeNaoEncTiposBasico import *\n\n')
        sys.stdout.write('import consMDFeNaoEncTiposBasico as model_\n\n')
