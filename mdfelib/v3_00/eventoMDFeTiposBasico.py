...
#   ('--no-process-includes', '')
#   ('-o', 'mdfelib/v3_00/eventoMDFeTiposBasico.py')
#
# Command line arguments:
#   schemas/v3_00/eventoMDFeTiposBasico_v3.00.xsd
#
# Command line:
#   /usr/local/bin/generateDS --no-process-includes -o "mdfelib/v3_00/eventoMDFeTiposBasico.py" schemas/v3_00/eventoMDFeTiposBasico_v3.00.xsd
#
...
def parseLiteral(inFileName, silence=False):
    ...
    doc = None
    if not silence:
        sys.stdout.write('#from eventoMDFeTiposBasico import *\n\n')
        sys.stdout.write('import eventoMDFeTiposBasico as model_\n\n')
