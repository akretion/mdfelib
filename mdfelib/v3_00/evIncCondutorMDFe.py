...
#
# Command line:
#   /usr/local/bin/generateDS --no-process-includes -o "mdfelib/v3_00/evIncCondutorMDFe.py" schemas/v3_00/evIncCondutorMDFe_v3.00.xsd
#
...
class evIncCondutorMDFe(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='ns1:', name_='evIncCondutorMDFe', namespacedef_='xmlns:ns1="http://www.portalfiscal.inf.br/mdfe"', pretty_print=True):
...
class descEvento(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='ns1:', name_='descEvento', namespacedef_='xmlns:ns1="http://www.portalfiscal.inf.br/mdfe"', pretty_print=True):
...
class condutor(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='ns1:', name_='condutor', namespacedef_='xmlns:ns1="http://www.portalfiscal.inf.br/mdfe"', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='ns1:', name_='condutor', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='ns1:', name_='condutor'):
        pass
    def exportChildren(self, outfile, level, namespace_='ns1:', name_='condutor', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class xNome(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='ns1:', name_='xNome', namespacedef_='xmlns:ns1="http://www.portalfiscal.inf.br/mdfe"', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='ns1:', name_='xNome', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='ns1:', name_='xNome'):
        pass
    def exportChildren(self, outfile, level, namespace_='ns1:', name_='xNome', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
