...
#
# Generated Tue Mar 20 04:00:42 2018 by generateDS.py version 2.28b.
# Python 3.5.2 (default, Sep 14 2017, 22:51:06)  [GCC 5.4.0 20160609]
#
# Command line options:
#   ('--no-process-includes', '')
#   ('-o', 'mdfelib/v3_00/consReciMDFeTiposBasico.py')
#
# Command line arguments:
#   schemas/v3_00/consReciMDFeTiposBasico_v3.00.xsd
#
# Command line:
#   /usr/local/bin/generateDS --no-process-includes -o "mdfelib/v3_00/consReciMDFeTiposBasico.py" schemas/v3_00/consReciMDFeTiposBasico_v3.00.xsd
#
...
class TProtMDFe(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='', name_='TProtMDFe', namespacedef_=' xmlns:ds="http://www.w3.org/2000/09/xmldsig#" ', pretty_print=True):
...
class infProt(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='infProt', fromsubclass_=False, pretty_print=True):
        ...
        if self.dhRecbto is not None:
            self.dhRecbto.export(outfile, level, namespace_, name_='dhRecbto', pretty_print=pretty_print)
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'tpAmb':
            ...
            obj_ = None
            self.dhRecbto = obj_
            obj_.original_tagname_ = 'dhRecbto'
...
class dhRecbto(GeneratedsSuper):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, dhRecbto)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if dhRecbto.subclass:
            return dhRecbto.subclass(*args_, **kwargs_)
        else:
            return dhRecbto(*args_, **kwargs_)
    factory = staticmethod(factory)
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='', name_='dhRecbto', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('dhRecbto')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='dhRecbto')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='', name_='dhRecbto', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='dhRecbto'):
        pass
    def exportChildren(self, outfile, level, namespace_='', name_='dhRecbto', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
...
def parseLiteral(inFileName, silence=False):
    ...
    doc = None
    if not silence:
        sys.stdout.write('#from consReciMDFeTiposBasico import *\n\n')
        sys.stdout.write('import consReciMDFeTiposBasico as model_\n\n')
