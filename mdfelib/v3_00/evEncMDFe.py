...
#
# Command line:
#   /usr/local/bin/generateDS --no-process-includes -o "mdfelib/v3_00/evEncMDFe.py" schemas/v3_00/evEncMDFe_v3.00.xsd
#
...
class evEncMDFe(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='ns1:', name_='evEncMDFe', namespacedef_='xmlns:ns1="http://www.portalfiscal.inf.br/mdfe"', pretty_print=True):
    ...
    def exportChildren(self, outfile, level, namespace_='ns1:', name_='evEncMDFe', fromsubclass_=False, pretty_print=True):
        ...
        if self.dtEnc is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sdtEnc>%s</%sdtEnc>%s' % (namespace_, self.gds_encode(self.gds_format_string(quote_xml(self.dtEnc), input_name='dtEnc')), namespace_, eol_))
