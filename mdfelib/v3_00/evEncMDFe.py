...
#
# Generated Tue Sep 19 18:32:12 2023 by generateDS.py version 2.43.2.
...
#
# Command line:
#   /usr/local/bin/generateDS -o "mdfelib/v3_00/evEncMDFe.py" schemas/v3_00/evEncMDFe_v3.00.xsd
#
...
class evEncMDFe(GeneratedsSuper):
    """evEncMDFe -- Schema XML de valida
    ç
    ã
    o do evento do encerramento
    110112
    descEvento -- Descri
    ç
    ã
    ...
    ü
    encial no ano.
    dtEnc -- Data que o Manifesto foi encerrado
    cUF -- UF de encerramento do Manifesto
    cMun -- C
    ó
    digo do Munic
    í
    pio de Encerramento do manifesto
    
    """
    __hash__ = GeneratedsSuper.__hash__
    subclass = None
    superclass = None
    def __init__(self, descEvento=None, nProt=None, dtEnc=None, cUF=None, cMun=None, gds_collector_=None, **kwargs_):
    ...
    def validate_TCodUfIBGE_EX(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            ...
            if value not in enumerations:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s"%(lineno)s does not match xsd enumeration restriction on TCodUfIBGE_EX' % {"value" : encode_str_2_3(value), "lineno": lineno} )
                result = False
        return result
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:ns1="http://www.portalfiscal.inf.br/mdfe" xmlns:None="http://www.w3.org/2001/XMLSchema" ', name_='evEncMDFe', pretty_print=True):
        ...
        if pretty_print:
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'evEncMDFe':
        ...
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='evEncMDFe')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='evEncMDFe', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='evEncMDFe'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:ns1="http://www.portalfiscal.inf.br/mdfe" xmlns:None="http://www.w3.org/2001/XMLSchema" ', name_='evEncMDFe', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.dtEnc is not None:
            namespaceprefix_ = self.dtEnc_nsprefix_ + ':' if (UseCapturedNS_ and self.dtEnc_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sdtEnc>%s</%sdtEnc>%s' % (namespaceprefix_ , self.gds_encode(self.gds_format_string(quote_xml(self.dtEnc), input_name='dtEnc')), namespaceprefix_ , eol_))
    ...
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'descEvento':
            ...
            value_ = child_.text
            value_ = self.gds_parse_string(value_, node, 'dtEnc')
            value_ = self.gds_validate_string(value_, node, 'dtEnc')
            self.dtEnc = value_
            self.dtEnc_nsprefix_ = child_.prefix
            # validate type TData
            self.validate_TData(self.dtEnc)
        elif nodeName_ == 'cUF':
            value_ = child_.text
