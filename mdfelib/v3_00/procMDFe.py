...
#
# Generated Tue Mar 20 04:00:48 2018 by generateDS.py version 2.28b.
...
#
# Command line:
#   /usr/local/bin/generateDS --no-process-includes -o "mdfelib/v3_00/procMDFe.py" schemas/v3_00/procMDFe_v3.00.xsd
#
...
class mdfeProc(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='mdfeProc', fromsubclass_=False, pretty_print=True):
        ...
        if self.MDFe is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sMDFe>%s</%sMDFe>%s' % (namespace_, self.gds_encode(self.gds_format_string(quote_xml(self.MDFe), input_name='MDFe')), namespace_, eol_))
        if self.protMDFe is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sprotMDFe>%s</%sprotMDFe>%s' % (namespace_, self.gds_encode(self.gds_format_string(quote_xml(self.protMDFe), input_name='protMDFe')), namespace_, eol_))
    def build(self, node):
        already_processed = set()
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'MDFe':
            MDFe_ = child_.text
            MDFe_ = self.gds_validate_string(MDFe_, node, 'MDFe')
            self.MDFe = MDFe_
        elif nodeName_ == 'protMDFe':
            protMDFe_ = child_.text
            protMDFe_ = self.gds_validate_string(protMDFe_, node, 'protMDFe')
            self.protMDFe = protMDFe_
# end class mdfeProc
