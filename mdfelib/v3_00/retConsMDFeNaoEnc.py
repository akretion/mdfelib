...
#
# Generated Tue Sep 19 18:30:57 2023 by generateDS.py version 2.43.2.
# Python 3.10.12 (main, Jun 11 2023, 05:26:28) [GCC 11.4.0]
#
# Command line options:
#   ('-o', 'mdfelib/v3_00/retConsMDFeNaoEnc.py')
#
# Command line arguments:
#   schemas/v3_00/retConsMDFeNaoEnc_v3.00.xsd
#
# Command line:
#   /usr/local/bin/generateDS -o "mdfelib/v3_00/retConsMDFeNaoEnc.py" schemas/v3_00/retConsMDFeNaoEnc_v3.00.xsd
#
...
class TConsMDFeNaoEnc(GeneratedsSuper):
    """TConsMDFeNaoEnc -- Tipo Pedido de Consulta MDF-e N
    ã
    o Encerrados
    tpAmb -- Identifica
    ç
    ...
    ç
    o Solicitado
    CNPJ -- CNPJ do Emitente do MDF-e
    
    """
    __hash__ = GeneratedsSuper.__hash__
    subclass = None
    superclass = None
    def __init__(self, versao=None, tpAmb=None, xServ=None, CNPJ=None, gds_collector_=None, **kwargs_):
    ...
    def validate_versaoType(self, value):
        # Validate type versaoType, a restriction on TVerConsMDFeNaoEnc.
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, str):
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s"%(lineno)s is not of the correct base simple type (str)' % {"value": value, "lineno": lineno, })
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.w3.org/2001/XMLSchema" ', name_='TConsMDFeNaoEnc', pretty_print=True):
        ...
        if pretty_print:
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'TConsMDFeNaoEnc':
        ...
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='TConsMDFeNaoEnc')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='TConsMDFeNaoEnc', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='TConsMDFeNaoEnc'):
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.w3.org/2001/XMLSchema" ', name_='TConsMDFeNaoEnc', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class TRetConsMDFeNaoEnc(GeneratedsSuper):
    """TRetConsMDFeNaoEnc -- Tipo Retorno de Pedido de Consulta MDF-e n
    ã
    o Encerrados
    tpAmb -- Identifica
    ç
    ...
    subclass = None
    superclass = None
    def __init__(self, versao=None, tpAmb=None, verAplic=None, cStat=None, xMotivo=None, cUF=None, infMDFe=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
    ...
    def set_infMDFe(self, infMDFe):
        self.infMDFe = infMDFe
    def add_infMDFe(self, value):
        self.infMDFe.append(value)
    def insert_infMDFe_at(self, index, value):
        self.infMDFe.insert(index, value)
    def replace_infMDFe_at(self, index, value):
        self.infMDFe[index] = value
    def get_versao(self):
        return self.versao
    def set_versao(self, versao):
        self.versao = versao
    ...
    def validate_TVerConsMDFeNaoEnc(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            ...
            if not self.gds_validate_simple_patterns(
                ...
                self.gds_collector_.add_message('Value "%s" does not match xsd pattern restrictions: %s' % (encode_str_2_3(value), self.validate_TVerConsMDFeNaoEnc_patterns_, ))
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.w3.org/2001/XMLSchema" ', name_='TRetConsMDFeNaoEnc', pretty_print=True):
        ...
        if pretty_print:
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'TRetConsMDFeNaoEnc':
            name_ = self.original_tagname_
        if UseCapturedNS_ and self.ns_prefix_:
            namespaceprefix_ = self.ns_prefix_ + ':'
        showIndent(outfile, level, pretty_print)
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='TRetConsMDFeNaoEnc')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='TRetConsMDFeNaoEnc', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='TRetConsMDFeNaoEnc'):
        if self.versao is not None and 'versao' not in already_processed:
            already_processed.add('versao')
            outfile.write(' versao=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.versao), input_name='versao')), ))
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.w3.org/2001/XMLSchema" ', name_='TRetConsMDFeNaoEnc', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        for infMDFe_ in self.infMDFe:
            ...
            infMDFe_.export(outfile, level, namespaceprefix_, namespacedef_='', name_='infMDFe', pretty_print=pretty_print)
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
            self.gds_elementtree_node_ = node
...
class infMDFeType(GeneratedsSuper):
    """chMDFe -- Chaves de acesso do MDF-e n
    ã
    o encerrado
    nProt -- N
    ú
    mero do Protocolo de autoriza
    ç
    ã
    o do MDF-e n
    ã
    ...
    subclass = None
    superclass = None
    def __init__(self, chMDFe=None, nProt=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
...
def parse(inFileName, silence=False, print_warnings=True):
    ...
    if rootClass is None:
        rootTag = 'TRetConsMDFeNaoEnc'
        rootClass = TRetConsMDFeNaoEnc
...
def parseLiteral(inFileName, silence=False, print_warnings=True):
    ...
    if not SaveElementTreeNode:
        ...
        rootNode = None
    if not silence:
        sys.stdout.write('#from retConsMDFeNaoEnc import *\n\n')
        sys.stdout.write('import retConsMDFeNaoEnc as model_\n\n')
...
NamespaceToDefMappings_ = {'http://www.portalfiscal.inf.br/mdfe': [('TDateTimeUTC',
                                         ...
                                         ('TPlaca',
                                          ...
                                          'ST'),
                                         ('TVerConsMDFeNaoEnc',
                                          'schemas/v3_00/consMDFeNaoEncTiposBasico_v3.00.xsd',
                                          'ST'),
                                         ('TConsMDFeNaoEnc',
                                          'schemas/v3_00/consMDFeNaoEncTiposBasico_v3.00.xsd',
                                          'CT'),
