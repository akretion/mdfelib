...
#   ('--no-process-includes', '')
#   ('-o', 'mdfelib/v3_00/consStatServTiposBasico.py')
#
# Command line arguments:
#   schemas/v3_00/consStatServTiposBasico_v3.00.xsd
#
# Command line:
#   /usr/local/bin/generateDS --no-process-includes -o "mdfelib/v3_00/consStatServTiposBasico.py" schemas/v3_00/consStatServTiposBasico_v3.00.xsd
#
